...
export type QueryWorkOrdersQuery = { __typename?: 'Query', queryWorkOrders?: Array<{ __typename?: 'WorkOrder', date: string, lastUpdated: string, type: string, description: string, completed: boolean, completedBy: string, quote: number, total: number, charged: boolean, paid: boolean, comments: string, customerId: { __typename?: 'Customer', _id: string, firstName: string, lastName: string }, propertyId: { __typename?: 'Property', _id: string }, invoices: Array<{ __typename?: 'Invoice', _id: string, date: string, total: number, paid: boolean } | null> }> | null };
